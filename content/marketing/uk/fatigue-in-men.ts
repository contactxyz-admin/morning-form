 ...
 * Fatigue in men — UK
 *
 * Anchor page targeting "why am I always tired male 35", "fatigue in men
 * blood test", "low energy despite sleeping". Path A regulatory posture:
 * descriptive, not prescriptive. No dose strings, no Rx names, no
 * imperative-treatment language. The escalation panel handles
 * clinician-mediated steps.
 */
  ...
  faq: [
    {
      ...
      answer:
        'A full blood count, ferritin, vitamin D, TSH and free T4, total and free testosterone, SHBG, HbA1c, and CRP cover the highest-yield markers for fatigue in men. Most UK private providers (Medichecks, Thriva, Bupa) bundle these into a "men over 30" or "energy" panel. NHS panels are typically narrower; ask your GP what is included.',
    },
    {
      question: 'Could low ferritin cause fatigue if my haemoglobin is normal?',
      answer:
        'Yes. Iron stores can be depleted long before red blood cell production drops. In men who train, donate blood, or eat plant-forward diets, ferritin in single digits with normal haemoglobin is a recognised pattern in the literature. The right next step is a conversation with your clinician about whether to investigate cause and how to track the marker.',
    },
    {
