...
- [x] **U1: `SourceView` carries `canonicalKey` + optional `change`/`interpretation`**
...
- [x] **U2: Source route enriches referenced nodes (flag-gated, non-fatal)**
...
- [x] **U3: Authed page renders value/flag + drill-down; shared body callback takes the marker**
...
- [x] **U4: Authed filtered-while-selected guard (D11)**
...
- [x] **U5: Reset-filters control (+ optional counts) (D7)**
...
> **Status (this cycle):** U1–U5 shipped. **U6 (URL-persist) and U7 (eased fade)
> deferred** — both are Phase-2 polish that are visual-audit-gated / cross-surface
> and carry the most integration risk in the carefully-reviewed dim effect + dual
> URL-state plumbing; best done paired with a live audit. Tracked for a fast-follow.
