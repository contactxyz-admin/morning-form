import type { StateProfile, Protocol, ProtocolItem, WeeklyReview, MorningCheckIn, EveningCheckIn, HealthSummary } from '@/types';
...
export const mockWeeklyReview: WeeklyReview = {
  ...
  weekEnd: '2026-03-26',
  sleepQuality: { filled: 5, total: 7, trend: 'improving', label: '5 of 7 nights rated "Well" or better' },
  focusConsistency: { filled: 4, total: 7, trend: 'stable', label: '4 of 7 days rated "Good" or better' },
  protocolAdherence: { filled: 6, total: 7, trend: 'improving', label: '6 of 7 days "Fully" or "Mostly"' },
  patternInsight: 'Your best focus days followed nights where you completed your evening protocol before 10pm.',
  protocolStatus: 'no-changes',
};

export const mockCheckInHistory: { date: string; morning?: MorningCheckIn; evening?: EveningCheckIn }[] = [
  { date: '2026-03-20', morning: { sleepQuality: 'ok', currentFeeling: 'flat' }, evening: { focusQuality: 'variable', afternoonEnergy: 'dipped', protocolAdherence: 'mostly' } },
  { date: '2026-03-21', morning: { sleepQuality: 'well', currentFeeling: 'steady' }, evening: { focusQuality: 'good', afternoonEnergy: 'steady', protocolAdherence: 'fully' } },
  { date: '2026-03-22', morning: { sleepQuality: 'well', currentFeeling: 'sharp' }, evening: { focusQuality: 'locked-in', afternoonEnergy: 'strong', protocolAdherence: 'fully' } },
  { date: '2026-03-23', morning: { sleepQuality: 'poorly', currentFeeling: 'low' }, evening: { focusQuality: 'scattered', afternoonEnergy: 'crashed', protocolAdherence: 'partially' } },
  { date: '2026-03-24', morning: { sleepQuality: 'ok', currentFeeling: 'flat' }, evening: { focusQuality: 'variable', afternoonEnergy: 'dipped', protocolAdherence: 'fully' } },
  { date: '2026-03-25', morning: { sleepQuality: 'great', currentFeeling: 'sharp' }, evening: { focusQuality: 'good', afternoonEnergy: 'steady', protocolAdherence: 'fully' } },
  { date: '2026-03-26', morning: { sleepQuality: 'well', currentFeeling: 'steady' }, evening: { focusQuality: 'good', afternoonEnergy: 'steady', protocolAdherence: 'mostly' } },
];
...
export const mockHealthHistory = Array.from({ length: 7 }, (_, i) => {
  ...
  return {
    ...
    sleepDuration: 6.5 + Math.random() * 1.5,
    restingHR: 48 + Math.floor(Math.random() * 10),
