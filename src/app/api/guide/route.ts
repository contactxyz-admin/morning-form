...
const responsePatterns: [RegExp, string][] = [
  ...
  [/l.?tyrosine/i, 'L-tyrosine is an amino acid precursor to dopamine. In your protocol, it supports sustained focus in the morning without the adrenergic stimulation of caffeine. At 500mg, it provides meaningful dopaminergic support without exceeding well-tolerated thresholds.\n\nIt works best on an empty stomach, which is why we recommend it before breakfast.'],
  [/alpha.?gpc/i, 'Alpha-GPC is a choline compound that supports acetylcholine synthesis — the neurotransmitter most associated with attention and working memory. At 300mg, it pairs well with L-tyrosine to provide dual-pathway cognitive support.\n\nSome people notice sharper recall and quicker thinking. The effect is subtle, not dramatic.'],
  [/theanine/i, 'L-theanine is an amino acid found naturally in tea. It promotes alpha brain wave activity — the state associated with calm alertness. At 200mg, it reduces norepinephrine without causing drowsiness.\n\nIn your protocol, it serves as a transition buffer between your morning activation and evening downshift.'],
  ...
  [/apigenin/i, 'Apigenin is a flavonoid found in chamomile. At 50mg, it acts as a mild anxiolytic by binding to benzodiazepine receptors — but without the dependence risk of pharmaceutical benzodiazepines.\n\nIt supports natural sleepiness and pairs well with magnesium L-threonate for your evening downshift.'],
