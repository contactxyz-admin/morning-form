  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <main>
        ...
        {/* Final CTA — a distinct secondary action from the hero's, so a
            visitor who reads the whole page gets a next step, not a repeat. */}
        <FinalCtaBand
          heading="Bring Morning Form to your club."
          body={
            <>
              Tell us about your club or studio, and we&rsquo;ll be in touch to set up your
              first draw day.
            </>
          }
        >
      ...
      <MarketingFooter market={market} currentPage="partners" />
    </div>
  );
}
